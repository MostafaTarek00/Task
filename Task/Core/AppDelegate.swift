...
class AppDelegate: UIResponder, UIApplicationDelegate , MOLHResetable{
    ...
    func reset() {
        ...
        let stry = UIStoryboard(name: "Tab", bundle: nil)
            rootviewcontroller.rootViewController = stry.instantiateViewController(withIdentifier: "TextyTabBarController")
    }
...
//    func getFirabseToken(){
//        InstanceID.instanceID().instanceID { (result, error) in
//            if let error = error {
//                print("Error: \(error)")
//            } else if let result = result {
//                print("Remote instance: \(result.token)")
//                UserDefault.setFireBaseToken(result.token)
//            }
//        }
//    }
//
...
//        print(userInfo)
//
//        //        if let storyBoard: UIStoryboard = UIStoryboard(name: "Tab", bundle: nil){
//        //            if let presentViewController = storyBoard.instantiateViewController(withIdentifier: "CustomTabViewController") as? CustomTabViewController {
//        //
...
////            if  let vc = storBoared.instantiateViewController(withIdentifier: "TextyTabBarController") as?  TextyTabBarController {
